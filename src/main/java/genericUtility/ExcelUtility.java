...
/**
 * This is an utility class deals with excel file
 * @author Keerthana
 * @version 26-3-23
 */
public class ExcelUtility {
/**
 * This is a generic method to fetch the single cell data from Excel files
 * @param sheetname
 * @param rowIndex
 * @param cellIndex
 * @return
 ...
 */
	...
	/**
	 * This is a generic method for fetching multiple cell data from excel file
	 * @param sheetName
	 * @param startRowIndex
	...
	/**
	 * This is an genric data to write data to excel file
	 * @param sheetName
	 * @param rowIndex
	 * @param cellIndex
	 * @param value
